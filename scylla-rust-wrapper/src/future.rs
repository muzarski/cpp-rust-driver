...
pub type CassFutureCallback =
    Option<unsafe extern "C" fn(future: CassBorrowedConstPtr<CassFuture, CMut>, data: *mut c_void)>;
...
impl BoundCallback {
    fn invoke(self, fut_ptr: CassBorrowedConstPtr<CassFuture, CMut>) {
        unsafe {
...
impl CassFuture {
    ...
    pub unsafe fn set_callback(
        &self,
        self_ptr: CassBorrowedConstPtr<CassFuture, CMut>,
    ...
    fn into_raw(self: Arc<Self>) -> CassOwnedConstPtr<Self, CMut> {
...
pub unsafe extern "C" fn cass_future_set_callback(
    future_raw: CassBorrowedConstPtr<CassFuture, CMut>,
...
#[no_mangle]
pub unsafe extern "C" fn cass_future_wait(future_raw: CassBorrowedConstPtr<CassFuture, CMut>) {
...
pub unsafe extern "C" fn cass_future_error_message(
    future: CassBorrowedConstPtr<CassFuture, CMut>,
...
#[no_mangle]
pub unsafe extern "C" fn cass_future_free(future_raw: CassOwnedConstPtr<CassFuture, CMut>) {
...
pub unsafe extern "C" fn cass_future_get_result(
    future_raw: CassBorrowedConstPtr<CassFuture, CMut>,
) -> CassOwnedConstPtr<CassResult, CConst> {
    ArcFFI::as_ref(future_raw)
        .unwrap()
...
pub unsafe extern "C" fn cass_future_get_error_result(
    future_raw: CassBorrowedConstPtr<CassFuture, CMut>,
) -> CassOwnedConstPtr<CassErrorResult, CConst> {
    ArcFFI::as_ref(future_raw)
        .unwrap()
...
pub unsafe extern "C" fn cass_future_get_prepared(
    future_raw: CassBorrowedConstPtr<CassFuture, CMut>,
) -> CassOwnedConstPtr<CassPrepared, CConst> {
    ArcFFI::as_ref(future_raw)
        .unwrap()
...
mod tests {
    ...
    fn cass_future_thread_safety() {
        ...
        struct PtrWrapper(CassBorrowedConstPtr<'static, CassFuture, CMut>);
        ...
        unsafe {
            ...
            let static_cass_fut_ref = std::mem::transmute::<
                CassBorrowedConstPtr<'_, CassFuture, CMut>,
                CassBorrowedConstPtr<'static, CassFuture, CMut>,
            >(cass_fut.borrow());
        ...
        unsafe {
            ...
            let create_future_and_flag = || {
                unsafe extern "C" fn mark_flag_cb(
                    _fut: CassBorrowedConstPtr<CassFuture, CMut>,
                    data: *mut c_void,
                ) {
