...
#[no_mangle]
pub unsafe extern "C" fn cass_tuple_new(item_count: size_t) -> CassOwnedMutPtr<CassTuple, CMut> {
...
) -> CassOwnedMutPtr<CassTuple, CMut> {
...
#[no_mangle]
unsafe extern "C" fn cass_tuple_free(tuple: CassOwnedMutPtr<CassTuple, CMut>) {
    BoxFFI::free(tuple);
}

#[no_mangle]
unsafe extern "C" fn cass_tuple_data_type(
    tuple: CassBorrowedConstPtr<CassTuple, CConst>,
