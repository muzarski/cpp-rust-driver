...
pub unsafe extern "C" fn cass_user_type_new_from_data_type(
    data_type_raw: CassBorrowedConstPtr<CassDataType, CConst>,
) -> CassOwnedMutPtr<CassUserType, CMut> {
...
#[no_mangle]
pub unsafe extern "C" fn cass_user_type_free(user_type: CassOwnedMutPtr<CassUserType, CMut>) {
    BoxFFI::free(user_type);
}
#[no_mangle]
pub unsafe extern "C" fn cass_user_type_data_type(
    user_type: CassBorrowedConstPtr<CassUserType, CConst>,
