use crate::argconv::{arr_to_cstr, ptr_to_cstr, str_to_arr, CConst, CassBorrowedConstPtr, RefFFI};
...
pub type CassLogCallback = Option<
    unsafe extern "C" fn(message: CassBorrowedConstPtr<CassLogMessage, CConst>, data: *mut c_void),
>;

unsafe extern "C" fn noop_log_callback(
    _message: CassBorrowedConstPtr<CassLogMessage, CConst>,
    _data: *mut c_void,
) {
}
...
pub unsafe extern "C" fn stderr_log_callback(
    message: CassBorrowedConstPtr<CassLogMessage, CConst>,
    _data: *mut c_void,
) {
