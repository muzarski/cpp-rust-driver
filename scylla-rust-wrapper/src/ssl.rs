use crate::argconv::{ArcFFI, CMut, CassBorrowedConstPtr, CassOwnedConstPtr, FromArc, FFI};
...
#[no_mangle]
pub unsafe extern "C" fn cass_ssl_new() -> CassOwnedConstPtr<CassSsl, CMut> {
    openssl_sys::init();
    cass_ssl_new_no_lib_init()
}

#[no_mangle]
pub unsafe extern "C" fn cass_ssl_new_no_lib_init() -> CassOwnedConstPtr<CassSsl, CMut> {
...
#[no_mangle]
pub unsafe extern "C" fn cass_ssl_free(ssl: CassOwnedConstPtr<CassSsl, CMut>) {
    ArcFFI::free(ssl);
}
