...
) -> CassOwnedConstPtr<CassDataType, CMut> {
...
pub unsafe extern "C" fn cass_data_type_new_from_existing(
    data_type: CassBorrowedConstPtr<CassDataType, CConst>,
) -> CassOwnedConstPtr<CassDataType, CMut> {
...
#[no_mangle]
pub unsafe extern "C" fn cass_data_type_free(data_type: CassOwnedConstPtr<CassDataType, CMut>) {
...
pub unsafe extern "C" fn cass_data_type_set_type_name(
    data_type: CassBorrowedConstPtr<CassDataType, CMut>,
...
pub unsafe extern "C" fn cass_data_type_set_type_name_n(
    data_type_raw: CassBorrowedConstPtr<CassDataType, CMut>,
    type_name: *const c_char,
...
pub unsafe extern "C" fn cass_data_type_add_sub_type(
    data_type: CassBorrowedConstPtr<CassDataType, CMut>,
    sub_data_type: CassBorrowedConstPtr<CassDataType, CConst>,
) -> CassError {
    let data_type = ArcFFI::as_ref(data_type).unwrap();
    match data_type
        .get_mut_unchecked()
...
pub unsafe extern "C" fn cass_data_type_add_sub_type_by_name_n(
    ...
    name: *const c_char,
    name_length: size_t,
    sub_data_type_raw: CassBorrowedConstPtr<CassDataType, CConst>,
) -> CassError {
