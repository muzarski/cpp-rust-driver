use crate::argconv::{
    write_str_to_c, ArcFFI, BoxFFI, CConst, CMut, CassBorrowedConstPtr, CassBorrowedMutPtr,
...
pub unsafe extern "C" fn cass_iterator_type(
    iterator: CassBorrowedMutPtr<CassIterator, CMut>,
) -> CassIteratorType {
...
pub unsafe extern "C" fn cass_iterator_get_row<'result>(
    iterator: CassBorrowedConstPtr<CassIterator<'result>, CConst>,
) -> CassBorrowedConstPtr<'result, CassRow, CConst> {
    let iter = BoxFFI::as_ref(iterator).unwrap();
...
pub unsafe extern "C" fn cass_iterator_get_column<'result>(
    iterator: CassBorrowedConstPtr<CassIterator<'result>, CConst>,
) -> CassBorrowedConstPtr<'result, CassValue, CConst> {
    let iter = BoxFFI::as_ref(iterator).unwrap();
...
pub unsafe extern "C" fn cass_iterator_get_user_type_field_name(
    iterator: CassBorrowedConstPtr<CassIterator, CConst>,
...
pub unsafe extern "C" fn cass_iterator_get_user_type_field_value<'schema>(
    iterator: CassBorrowedConstPtr<CassIterator<'schema>, CConst>,
) -> CassBorrowedConstPtr<'schema, CassValue, CConst> {
    let iter = BoxFFI::as_ref(iterator).unwrap();
...
pub unsafe extern "C" fn cass_iterator_get_keyspace_meta<'schema>(
    iterator: CassBorrowedConstPtr<CassIterator<'schema>, CConst>,
) -> CassBorrowedConstPtr<'schema, CassKeyspaceMeta, CConst> {
    let iter = BoxFFI::as_ref(iterator).unwrap();
...
pub unsafe extern "C" fn cass_iterator_get_table_meta<'schema>(
    iterator: CassBorrowedConstPtr<CassIterator<'schema>, CConst>,
) -> CassBorrowedConstPtr<'schema, CassTableMeta, CConst> {
    let iter = BoxFFI::as_ref(iterator).unwrap();
...
pub unsafe extern "C" fn cass_iterator_get_user_type<'schema>(
    iterator: CassBorrowedConstPtr<CassIterator<'schema>, CConst>,
) -> CassBorrowedConstPtr<'schema, CassDataType, CConst> {
    let iter = BoxFFI::as_ref(iterator).unwrap();
...
pub unsafe extern "C" fn cass_iterator_get_column_meta<'schema>(
    iterator: CassBorrowedConstPtr<CassIterator<'schema>, CConst>,
) -> CassBorrowedConstPtr<'schema, CassColumnMeta, CConst> {
    let iter = BoxFFI::as_ref(iterator).unwrap();
...
pub unsafe extern "C" fn cass_iterator_get_materialized_view_meta<'schema>(
    iterator: CassBorrowedConstPtr<CassIterator<'schema>, CConst>,
) -> CassBorrowedConstPtr<'schema, CassMaterializedViewMeta, CConst> {
    let iter = BoxFFI::as_ref(iterator).unwrap();
...
pub unsafe extern "C" fn cass_iterator_from_result<'result>(
    result: CassBorrowedConstPtr<'result, CassResult, CConst>,
) -> CassOwnedMutPtr<CassIterator<'result>, CMut> {
...
pub unsafe extern "C" fn cass_iterator_from_row<'result>(
    row: CassBorrowedConstPtr<'result, CassRow, CConst>,
) -> CassOwnedMutPtr<CassIterator<'result>, CMut> {
...
pub unsafe extern "C" fn cass_iterator_from_collection<'result>(
    value: CassBorrowedConstPtr<'result, CassValue, CConst>,
) -> CassOwnedMutPtr<CassIterator<'result>, CMut> {
...
pub unsafe extern "C" fn cass_iterator_keyspaces_from_schema_meta<'schema>(
    schema_meta: CassBorrowedConstPtr<'schema, CassSchemaMeta, CConst>,
) -> CassOwnedMutPtr<CassIterator<'schema>, CMut> {
...
pub unsafe extern "C" fn cass_iterator_tables_from_keyspace_meta<'schema>(
    keyspace_meta: CassBorrowedConstPtr<'schema, CassKeyspaceMeta, CConst>,
) -> CassOwnedMutPtr<CassIterator<'schema>, CMut> {
...
pub unsafe extern "C" fn cass_iterator_columns_from_table_meta<'schema>(
    table_meta: CassBorrowedConstPtr<'schema, CassTableMeta, CConst>,
) -> CassOwnedMutPtr<CassIterator<'schema>, CMut> {
...
pub unsafe extern "C" fn cass_iterator_columns_from_materialized_view_meta<'schema>(
    view_meta: CassBorrowedConstPtr<'schema, CassMaterializedViewMeta, CConst>,
) -> CassOwnedMutPtr<CassIterator<'schema>, CMut> {
