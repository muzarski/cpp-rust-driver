...
#[no_mangle]
pub unsafe extern "C" fn cass_cluster_new() -> CassOwnedMutPtr<CassCluster, CMut> {
...
#[no_mangle]
pub unsafe extern "C" fn cass_cluster_free(cluster: CassOwnedMutPtr<CassCluster, CMut>) {
    BoxFFI::free(cluster);
}

#[no_mangle]
pub unsafe extern "C" fn cass_cluster_set_contact_points(
    cluster: CassBorrowedMutPtr<CassCluster, CMut>,
...
unsafe fn cluster_set_contact_points(
    cluster_raw: CassBorrowedMutPtr<CassCluster, CMut>,
...
pub unsafe extern "C" fn cass_cluster_set_use_randomized_contact_points(
    _cluster_raw: CassBorrowedMutPtr<CassCluster, CMut>,
...
pub extern "C" fn cass_future_custom_payload_item(
    _future: CassBorrowedMutPtr<CassFuture, CMut>,
    _i: size_t,
    _name: *const c_char,
    _name_length: size_t,
...
pub extern "C" fn cass_cluster_set_queue_size_event(
    _cluster: CassBorrowedMutPtr<CassCluster, CMut>,
    _queue_size: c_uint,
) -> CassError {
...
pub unsafe extern "C" fn cass_cluster_set_retry_policy(
    cluster_raw: CassBorrowedMutPtr<CassCluster, CMut>,
    retry_policy: CassBorrowedConstPtr<CassRetryPolicy, CMut>,
) {
    let cluster = BoxFFI::as_mut_ref(cluster_raw).unwrap();
...
pub unsafe extern "C" fn cass_cluster_set_ssl(
    cluster: CassBorrowedMutPtr<CassCluster, CMut>,
    ssl: CassBorrowedConstPtr<CassSsl, CMut>,
) {
...
pub unsafe extern "C" fn cass_cluster_set_execution_profile(
    cluster: CassBorrowedMutPtr<CassCluster, CMut>,
    name: *const c_char,
    profile: CassBorrowedMutPtr<CassExecProfile, CMut>,
) -> CassError {
