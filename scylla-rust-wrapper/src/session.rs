...
impl CassSessionInner {
    ...
    ) -> CassOwnedConstPtr<CassFuture, CMut> {
...
#[no_mangle]
pub unsafe extern "C" fn cass_session_new() -> CassOwnedConstPtr<CassSession, CMut> {
...
pub unsafe extern "C" fn cass_session_connect(
    session_raw: CassBorrowedConstPtr<CassSession, CMut>,
    cluster_raw: CassBorrowedConstPtr<CassCluster, CConst>,
) -> CassOwnedConstPtr<CassFuture, CMut> {
...
pub unsafe extern "C" fn cass_session_execute_batch(
    session_raw: CassBorrowedConstPtr<CassSession, CMut>,
    batch_raw: CassBorrowedConstPtr<CassBatch, CConst>,
) -> CassOwnedConstPtr<CassFuture, CMut> {
    let session_opt = ArcFFI::cloned_from_ptr(session_raw).unwrap();
...
pub unsafe extern "C" fn cass_session_execute(
    session_raw: CassBorrowedConstPtr<CassSession, CMut>,
    statement_raw: CassBorrowedConstPtr<CassStatement, CConst>,
) -> CassOwnedConstPtr<CassFuture, CMut> {
    let session_opt = ArcFFI::cloned_from_ptr(session_raw).unwrap();
...
pub unsafe extern "C" fn cass_session_prepare_from_existing(
    cass_session: CassBorrowedConstPtr<CassSession, CMut>,
    statement: CassBorrowedConstPtr<CassStatement, CMut>,
) -> CassOwnedConstPtr<CassFuture, CMut> {
...
pub unsafe extern "C" fn cass_session_prepare(
    session: CassBorrowedConstPtr<CassSession, CMut>,
    query: *const c_char,
) -> CassOwnedConstPtr<CassFuture, CMut> {
...
pub unsafe extern "C" fn cass_session_prepare_n(
    cass_session_raw: CassBorrowedConstPtr<CassSession, CMut>,
    query: *const c_char,
    query_length: size_t,
) -> CassOwnedConstPtr<CassFuture, CMut> {
...
#[no_mangle]
pub unsafe extern "C" fn cass_session_free(session_raw: CassOwnedConstPtr<CassSession, CMut>) {
...
pub unsafe extern "C" fn cass_session_get_schema_meta(
    session: CassBorrowedConstPtr<CassSession, CConst>,
) -> CassOwnedMutPtr<CassSchemaMeta, CConst> {
    let cass_session = ArcFFI::as_ref(session).unwrap();
...
mod tests {
    ...
    unsafe fn cass_future_wait_check_and_free(fut: CassOwnedConstPtr<CassFuture, CMut>) {
        ...
        unsafe {
            ...
            ));
            {
                ...
                unsafe fn set_provided_exec_profile(
                    name: *const i8,
                    statement_raw: CassBorrowedMutPtr<CassStatement, CMut>,
                    batch_raw: CassBorrowedMutPtr<CassBatch, CMut>,
                ) {
                ...
                unsafe fn set_retry_policy_on_stmt(
                    policy: CassBorrowedConstPtr<CassRetryPolicy, CMut>,
                    statement_raw: CassBorrowedMutPtr<CassStatement, CMut>,
                    batch_raw: CassBorrowedMutPtr<CassBatch, CMut>,
                ) {
                    assert_cass_error_eq!(
