...
pub unsafe extern "C" fn cass_collection_new(
    ...
    item_count: size_t,
) -> CassOwnedMutPtr<CassCollection, CMut> {
...
unsafe extern "C" fn cass_collection_data_type(
    collection: CassBorrowedConstPtr<CassCollection, CConst>,
...
#[no_mangle]
pub unsafe extern "C" fn cass_collection_free(collection: CassOwnedMutPtr<CassCollection, CMut>) {
