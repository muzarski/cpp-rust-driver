...
pub unsafe extern "C" fn cass_schema_meta_free(
    schema_meta: CassOwnedMutPtr<CassSchemaMeta, CConst>,
) {
...
pub unsafe extern "C" fn cass_schema_meta_keyspace_by_name(
    schema_meta: CassBorrowedConstPtr<CassSchemaMeta, CConst>,
    keyspace_name: *const c_char,
) -> CassBorrowedConstPtr<CassKeyspaceMeta, CConst> {
...
pub unsafe extern "C" fn cass_keyspace_meta_name(
    keyspace_meta: CassBorrowedConstPtr<CassKeyspaceMeta, CConst>,
...
pub unsafe extern "C" fn cass_keyspace_meta_table_by_name(
    keyspace_meta: CassBorrowedConstPtr<CassKeyspaceMeta, CConst>,
    table: *const c_char,
) -> CassBorrowedConstPtr<CassTableMeta, CConst> {
...
pub unsafe extern "C" fn cass_table_meta_name(
    table_meta: CassBorrowedConstPtr<CassTableMeta, CConst>,
    name: *mut *const c_char,
    name_length: *mut size_t,
) {
...
pub unsafe extern "C" fn cass_table_meta_column(
    table_meta: CassBorrowedConstPtr<CassTableMeta, CConst>,
    index: size_t,
) -> CassBorrowedConstPtr<CassColumnMeta, CConst> {
...
pub unsafe extern "C" fn cass_column_meta_name(
    column_meta: CassBorrowedConstPtr<CassColumnMeta, CConst>,
    name: *mut *const c_char,
    name_length: *mut size_t,
) {
...
pub unsafe extern "C" fn cass_keyspace_meta_materialized_view_by_name(
    keyspace_meta: CassBorrowedConstPtr<CassKeyspaceMeta, CConst>,
    view: *const c_char,
) -> CassBorrowedConstPtr<CassMaterializedViewMeta, CConst> {
...
pub unsafe extern "C" fn cass_materialized_view_meta_column_by_name(
    view_meta: CassBorrowedConstPtr<CassMaterializedViewMeta, CConst>,
    column: *const c_char,
) -> CassBorrowedConstPtr<CassColumnMeta, CConst> {
