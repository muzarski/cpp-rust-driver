...
use crate::argconv::{
    ptr_to_cstr_n, strlen, ArcFFI, BoxFFI, CMut, CassBorrowedConstPtr, CassBorrowedMutPtr,
    CassOwnedMutPtr,
};
...
#[no_mangle]
pub unsafe extern "C" fn cass_execution_profile_new() -> CassOwnedMutPtr<CassExecProfile, CMut> {
    BoxFFI::into_ptr(Box::new(CassExecProfile::new()))
}

#[no_mangle]
pub unsafe extern "C" fn cass_execution_profile_free(
    profile: CassOwnedMutPtr<CassExecProfile, CMut>,
) {
    BoxFFI::free(profile);
}
...
pub unsafe extern "C" fn cass_statement_set_execution_profile(
    statement: CassBorrowedMutPtr<CassStatement, CMut>,
    name: *const c_char,
) -> CassError {
...
pub unsafe extern "C" fn cass_batch_set_execution_profile(
    batch: CassBorrowedMutPtr<CassBatch, CMut>,
    name: *const c_char,
) -> CassError {
