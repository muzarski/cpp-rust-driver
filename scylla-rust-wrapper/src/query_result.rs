...
#[no_mangle]
pub unsafe extern "C" fn cass_result_free(result_raw: CassOwnedPtr<CassResult, CConst>) {
    ArcFFI::free(result_raw);
}

#[no_mangle]
pub unsafe extern "C" fn cass_result_has_more_pages(
    result: CassBorrowedPtr<CassResult, CConst>,
) -> cass_bool_t {
    result_has_more_pages(&result)
}

unsafe fn result_has_more_pages(result: &CassBorrowedPtr<CassResult, CConst>) -> cass_bool_t {
...
pub unsafe extern "C" fn cass_result_column_data_type(
    result: CassBorrowedPtr<CassResult, CConst>,
    index: size_t,
) -> CassBorrowedPtr<CassDataType, CConst> {
...
pub unsafe extern "C" fn cass_value_type(
    value: CassBorrowedPtr<CassValue, CConst>,
) -> CassValueType {
...
pub unsafe extern "C" fn cass_value_item_count(
    collection: CassBorrowedPtr<CassValue, CConst>,
) -> size_t {
...
pub unsafe extern "C" fn cass_result_row_count(
    result_raw: CassBorrowedPtr<CassResult, CConst>,
) -> size_t {
...
pub unsafe extern "C" fn cass_result_first_row(
    result_raw: CassBorrowedPtr<CassResult, CConst>,
) -> CassBorrowedPtr<CassRow, CConst> {
    let result = ArcFFI::as_ref(result_raw).unwrap();
...
mod tests {
    ...
    use super::{
        cass_result_column_count, cass_result_column_type, CassBorrowedPtr, CassResult,
    ...
    unsafe fn cass_result_column_name_rust_str(
        result_ptr: CassBorrowedPtr<CassResult, CConst>,
        column_index: u64,
    ) -> Option<&'static str> {
