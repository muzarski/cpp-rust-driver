...
#[no_mangle]
pub unsafe extern "C" fn cass_result_free(result_raw: CassOwnedConstPtr<CassResult, CConst>) {
    ArcFFI::free(result_raw);
}

#[no_mangle]
pub unsafe extern "C" fn cass_result_has_more_pages(
    result: CassBorrowedConstPtr<CassResult, CConst>,
) -> cass_bool_t {
    result_has_more_pages(&result)
}

unsafe fn result_has_more_pages(result: &CassBorrowedConstPtr<CassResult, CConst>) -> cass_bool_t {
...
pub unsafe extern "C" fn cass_row_get_column(
    row_raw: CassBorrowedConstPtr<CassRow, CConst>,
    index: size_t,
) -> CassBorrowedConstPtr<CassValue, CConst> {
...
pub unsafe extern "C" fn cass_row_get_column_by_name(
    row: CassBorrowedConstPtr<CassRow, CConst>,
    name: *const c_char,
) -> CassBorrowedConstPtr<CassValue, CConst> {
...
pub unsafe extern "C" fn cass_result_column_data_type(
    result: CassBorrowedConstPtr<CassResult, CConst>,
    index: size_t,
) -> CassBorrowedConstPtr<CassDataType, CConst> {
...
pub unsafe extern "C" fn cass_value_type(
    value: CassBorrowedConstPtr<CassValue, CConst>,
) -> CassValueType {
...
pub unsafe extern "C" fn cass_value_item_count(
    collection: CassBorrowedConstPtr<CassValue, CConst>,
) -> size_t {
...
pub unsafe extern "C" fn cass_result_row_count(
    result_raw: CassBorrowedConstPtr<CassResult, CConst>,
) -> size_t {
...
pub unsafe extern "C" fn cass_result_first_row(
    result_raw: CassBorrowedConstPtr<CassResult, CConst>,
) -> CassBorrowedConstPtr<CassRow, CConst> {
    let result = ArcFFI::as_ref(result_raw).unwrap();
...
mod tests {
    ...
    use super::{
        ...
        CassBorrowedConstPtr, CassResult, CassResultKind, CassResultMetadata, CassRowsResult,
    };
    ...
    unsafe fn cass_result_column_name_rust_str(
        result_ptr: CassBorrowedConstPtr<CassResult, CConst>,
        column_index: u64,
    ) -> Option<&'static str> {
